...
zip_path = 'ReleasableAircraft.zip'
extract_path = 'FAA_Database'
temp_zip_path = 'temp_ReleasableAircraft.zip'
...
def check_and_update_file(url, zip_path, temp_zip_path, headers):
    if download_file(url, temp_zip_path, headers):
...
if check_and_update_file(url, zip_path, temp_zip_path, headers):
